...
from tvb_epilepsy.service.pse_service import pse_from_lsa_hypothesis
from tvb_epilepsy.service.sensitivity_analysis_service import sensitivity_analysis_pse_from_lsa_hypothesis
...
if SIMULATION_MODE is TVB:
    from tvb_epilepsy.service.simulation_service import setup_TVB_simulation_from_model_configuration \
        as setup_simulation_from_model_configuration
else:
    from tvb_epilepsy.service.simulation_service import setup_custom_simulation_from_model_configuration \
        as setup_simulation_from_model_configuration
