...
from tvb_epilepsy.base.constants.model_inversion_constants import X1EQ_MIN, X1EQ_MAX, SIG_INIT_DEF, SIG_DEF, \
...
class SDEStatisticalModel(ODEStatisticalModel):
    ...
    def __init__(self, name="sde_vep", n_regions=0, active_regions=[], n_signals=0,
                       n_times=0, dt=1.0, x1eq_min=X1EQ_MIN, x1eq_max=X1EQ_MAX, sig_init=SIG_INIT_DEF, sig=SIG_DEF,
        ...
        super(SDEStatisticalModel, self).__init__(name, n_regions, active_regions, n_signals, n_times, dt,
                                                  x1eq_min, x1eq_max, sig_init, observation_model,
