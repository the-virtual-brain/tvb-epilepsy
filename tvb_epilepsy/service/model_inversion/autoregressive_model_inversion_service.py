...
class AutoregressiveModelInversionService(OdeModelInversionService):
    ...
    def configure_statistical_model(self, statistical_model_name, parameters, euler_method="forward",
        ...
        return AutoregressiveStatisticalModel(statistical_model_name, "vep_autoregress", parameters,
                                   self.hypothesis.number_of_regions, active_regions, n_signals, n_times,
                                   euler_method,
