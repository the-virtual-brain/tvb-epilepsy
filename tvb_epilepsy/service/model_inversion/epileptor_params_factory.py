...
def generate_lognormal(name, high, low, mean, sigma=None, sigma_scale=3, p_shape=(), use="scipy"):
    if sigma is None:
...
def generate_negative_lognormal(name, high, low, mean, sigma=None, sigma_scale=3, p_shape=(), use="scipy"):
    return generate_lognormal(name, high - low, 0.0, high - mean, sigma, sigma_scale, p_shape, use)
