...
namespace vep_fe_rev_09dp_simple_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/dionperd/VEPtools/software/git/tvb-epilepsy/tvb_epilepsy/service/model_inversion/stan/models/vep-fe-rev-09dp_simple.stan");
    reader.add_event(157, 157, "end", "/Users/dionperd/VEPtools/software/git/tvb-epilepsy/tvb_epilepsy/service/model_inversion/stan/models/vep-fe-rev-09dp_simple.stan");
    return reader;
}
...
class vep_fe_rev_09dp_simple_model : public prob_grad {
private:
    int DEBUG;
    int SIMULATE;
    int nn;
    ...
    matrix_d SC_;
public:
    vep_fe_rev_09dp_simple_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vep_fe_rev_09dp_simple_model_namespace::vep_fe_rev_09dp_simple_model";
        ...
        try {
            ...
            stan::math::assign(time_scale,time_scale_mu);
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int t = 1; t <= (nt - 1); ++t) {
                ...
                lp_accum__.add(normal_log<propto__>(to_vector(get_base1(x_eta,t,"x_eta",1)), 0.0, 1.0));
                current_statement_begin__ = 142;
                lp_accum__.add(normal_log<propto__>(to_vector(get_base1(z_eta,t,"z_eta",1)), 0.0, 1.0));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "vep_fe_rev_09dp_simple_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "vep_fe_rev_09dp_simple_model";
    }
...
typedef vep_fe_rev_09dp_simple_model_namespace::vep_fe_rev_09dp_simple_model stan_model;
