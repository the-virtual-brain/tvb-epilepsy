...
namespace vep_fe_rev_08a_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/dionperd/VEPtools/software/git/tvb-epilepsy/tvb_epilepsy/stan/vep-fe-rev-08a.stan");
    reader.add_event(145, 145, "end", "/Users/dionperd/VEPtools/software/git/tvb-epilepsy/tvb_epilepsy/stan/vep-fe-rev-08a.stan");
    return reader;
}
...
vector_differencing(const Eigen::Matrix<T0__, 1,Eigen::Dynamic>& x, std::ostream* pstream__) {
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(transpose(D));
        }
...
class vep_fe_rev_08a_model : public prob_grad {
private:
    int DEBUG;
    int SIMULATE;
    int nn;
    ...
    matrix_d SC_;
public:
    vep_fe_rev_08a_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vep_fe_rev_08a_model_namespace::vep_fe_rev_08a_model";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "x0_std", "double", context__.to_vec());
            x0_std = double(0);
            vals_r__ = context__.vals_r("x0_std");
            pos__ = 0;
            x0_std = vals_r__[pos__++];
            current_statement_begin__ = 45;
            context__.validate_dims("data initialization", "x0_lo", "double", context__.to_vec());
            x0_lo = double(0);
            vals_r__ = context__.vals_r("x0_lo");
            pos__ = 0;
            x0_lo = vals_r__[pos__++];
            ...
            context__.validate_dims("data initialization", "init_std", "double", context__.to_vec());
            init_std = double(0);
            vals_r__ = context__.vals_r("init_std");
            pos__ = 0;
            init_std = vals_r__[pos__++];
            ...
            stan::math::assign(SC_, divide(SC_, (max(SC_) * rows(SC_))));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.row_vector_lub_unconstrain(x0_lo,x0_hi,x0);
        } catch (const std::exception& e) { 
        ...
        try {
            writer__.scalar_lb_unconstrain(amplitude_lo,amplitude);
        } catch (const std::exception& e) { 
        ...
        try {
            writer__.scalar_lb_unconstrain(0.0,sigma_star);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                x0 = in__.row_vector_lub_constrain(x0_lo,x0_hi,nn,lp__);
            else
                x0 = in__.row_vector_lub_constrain(x0_lo,x0_hi,nn);
            ...
            if (jacobian__)
                amplitude = in__.scalar_lb_constrain(amplitude_lo,lp__);
            else
                amplitude = in__.scalar_lb_constrain(amplitude_lo);
            ...
            if (jacobian__)
                sigma_star = in__.scalar_lb_constrain(0.0,lp__);
            else
                sigma_star = in__.scalar_lb_constrain(0.0);
            ...
            stan::math::assign(epsilon,(epsilon_mu * stan::math::exp(((epsilon_std / epsilon_mu) * epsilon_star))));
            ...
            stan::math::assign(sigma,(sigma_mu * stan::math::exp(((sigma_std / sigma_mu) * sigma_star))));
            ...
            stan::math::assign(time_scale,(time_scale_mu * stan::math::exp(((time_scale_std / time_scale_mu) * time_scale_star))));
            ...
            stan::math::assign(k,(k_mu * stan::math::exp(((k_std / k_mu) * k_star))));
            ...
            for (int t = 1; t <= nt; ++t) {
                ...
                stan::math::assign(get_base1_lhs(mu_seeg_log_power,t,"mu_seeg_log_power",1), multiply(amplitude,transpose(add(stan::math::log(multiply(gain,stan::math::exp(transpose(get_base1(x,t,"x",1))))),offset))));
            }
            ...
            lp_accum__.add(normal_log<propto__>(x0, x0_mu, x0_std));
            current_statement_begin__ = 117;
            lp_accum__.add(normal_log<propto__>(x_init, x_init_mu, init_std));
            current_statement_begin__ = 118;
            lp_accum__.add(normal_log<propto__>(z_init, z_init_mu, init_std));
            ...
            lp_accum__.add(normal_log<propto__>(amplitude, amplitude_mu, amplitude_std));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "vep_fe_rev_08a_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        row_vector_d x0 = in__.row_vector_lub_constrain(x0_lo,x0_hi,nn);
        double epsilon_star = in__.scalar_constrain();
        double amplitude = in__.scalar_lb_constrain(amplitude_lo);
        ...
        double sigma_star = in__.scalar_lb_constrain(0.0);
...
typedef vep_fe_rev_08a_model_namespace::vep_fe_rev_08a_model stan_model;
