...
class TestHypothesisBuilder(BaseTest):
    ...
    def test_build_hypothesis_by_user_preferences(self):
        hypo_builder = HypothesisBuilder(self.config).set_nr_of_regions(76).set_x0_hypothesis(
    ...
    def test_build_lsa_hypothesis(self):
        hypo_builder = HypothesisBuilder(self.config).set_nr_of_regions(76).set_x0_hypothesis([1, 2], [1, 1])
        hypo = hypo_builder.build_hypothesis()
