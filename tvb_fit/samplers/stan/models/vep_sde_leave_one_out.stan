...
data {
    ...
    int ind_known;
    real x_known;
    row_vector [n_active_regions-1] x_star_mu;
    row_vector [n_active_regions-1] x_star_std;
...
transformed data {
    ...
    row_vector[n_active_regions-1] x_logmu = normal_mean_std_to_lognorm_mu(x_star_mu, x_star_std);
    row_vector[n_active_regions-1] x_logsigma = normal_mean_std_to_lognorm_sigma(x_star_mu, x_star_std);
...
parameters {
    ...
    row_vector<upper=x_star_hi>[n_active_regions-1] x_star;
...
transformed parameters {
    ...
    real tau0;
    real K;
    row_vector[n_active_regions-1] x = x_hi - standard_normal_to_lognormal_row(x_star, x_logmu, x_logsigma);
