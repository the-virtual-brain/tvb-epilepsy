...
X1EQ_CR = X1EQ_CR_DEF
# X1_ANTI_CR = 0.0
X1EQ_MIDRANGE = 0.5 # (X1_ANTI_CR - X1EQ_CR)/2
X1EQ_MAX = X1EQ_CR + X1EQ_MIDRANGE  # -1.0  # X1EQ_CR_DEF
X1EQ_MIN = X1EQ_CR - X1EQ_MIDRANGE
X1EQ_DEF = X1_DEF
X1EQ_SCALE = 3.0
...
def compute_seizure_length(tau0):
    return np.maximum(16, int(np.ceil(64 * (1 + 2*np.log10(tau0 / 30.0)))))
