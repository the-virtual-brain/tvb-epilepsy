...
import numpy as np
from tvb_infer.base.utils.data_structures_utils import reg_dict, formal_repr, sort_dict, labels_to_inds
from tvb_infer.base.computations.math_utils import normalize_weights
