...
import numpy
from tvb_infer.base.utils.log_error_utils import initialize_logger, raise_not_implemented_error
...
if CalculusConfig.SYMBOLIC_CALCULATIONS_FLAG:
    ...
    try:
        ...
        from tvb_infer.tvb_epilepsy.base.computation_utils.symbolic_utils import symbol_vars, symbol_eqtn_fx1z, symbol_eqtn_fx2y2, \
