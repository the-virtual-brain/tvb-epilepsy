...
from tvb_infer.base.utils.log_error_utils import raise_value_error, raise_not_implemented_error
...
class EpileptorDPrealistic(Model):
    ...
    def fun_slope_Iext2(z, g, pmode, slope, Iext2):
        ...
        from tvb_infer.base.computations.analyzers_utils import interval_scaling
