from tvb_infer.tvb_epilepsy.base.constants.config import FiguresConfig
import matplotlib
...
from tvb_infer.tvb_epilepsy.base.constants.model_constants import X1EQ_CR_DEF, X1_DEF, X0_CR_DEF, X0_DEF
from tvb_infer.base.utils.data_structures_utils import isequal_string, generate_region_labels
from tvb_infer.tvb_epilepsy.base.computation_utils.calculations_utils import calc_fz, calc_fx1, calc_fx1_2d_taylor, \
                                                             calc_x0_val_to_model_x0
from tvb_infer.tvb_epilepsy.base.computation_utils.equilibrium_computation import calc_eq_y1, def_x1lin
