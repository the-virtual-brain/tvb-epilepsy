...
from tvb_infer.base.utils.data_structures_utils import ensure_list, isequal_string, sort_dict,  \
                                                          generate_region_labels, extract_dict_stringkeys
from tvb_infer.samplers.stan.stan_interface import merge_samples
...
class ModelInversionPlotter(TimeseriesPlotter):
    ...
    def plot_fit_results(self, ests, samples, model_data, target_data, probabilistic_model=None, info_crit=None,
        ...
        from tvb_infer.tvb_epilepsy.top.scripts.fitting_scripts import samples_to_timeseries
