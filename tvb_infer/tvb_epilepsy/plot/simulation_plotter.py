...
from tvb_infer.tvb_epilepsy.base.model.epileptor_models import EpileptorDP2D, EpileptorDPrealistic
from tvb_infer.base.model.timeseries import TimeseriesDimensions, PossibleVariables
