...
from tvb_infer.tvb_epilepsy.service.probabilistic_models_builders import SDEProbabilisticModelBuilder
from tvb_infer.tvb_epilepsy.service.model_inversion_services import SDEModelInversionService
from tvb_infer.samplers.stan.cmdstan_interface import CmdStanInterface
from tvb_infer.tvb_epilepsy.service.vep_stan_dict_builder import build_stan_model_data_dict
from tvb_infer.tvb_epilepsy.top.scripts.simulation_scripts import from_model_configuration_to_simulation
from tvb_infer.tvb_epilepsy.top.scripts.fitting_scripts import set_model_config_LSA, set_empirical_data, \
...
def main_fit_sim_hyplsa(stan_model_name="vep_sde", empirical_file="",
    ...
    for hyp in hypotheses[:1]:
        ...
        if os.path.isfile(problstc_model_file) and os.path.isfile(model_data_file) and os.path.isfile(target_data_file):
            ...
            # from tvb_infer.service.model_inversion.vep_stan_dict_builder import \
